...
//		Log.d(TAG, name + " ispatchDraw " + mState);
    ...
    private boolean touchFromHandle = false;
...
//					// ... and set initial panel's position
    ...
    MyLinearLayout.PanelTouchUpListener panelOnTouchupListener = new MyLinearLayout.PanelTouchUpListener() {
        @Override
    ...
    public MyLinearLayout.PanelTouchUpListener getPanelOnTouchupListener() {
        return panelOnTouchupListener;
    }
}
