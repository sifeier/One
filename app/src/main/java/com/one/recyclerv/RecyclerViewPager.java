...
public class RecyclerViewPager extends RecyclerView {
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyle) {
        final TypedArray a = context
                .obtainStyledAttributes(attrs, R.styleable.RecyclerViewPager, defStyle,
                        0);
        ...
        mSinglePageFling = a
                .getBoolean(R.styleable.RecyclerViewPager_singlePageFling, mSinglePageFling);
    ...
    public boolean fling(int velocityX, int velocityY) {
        boolean flinging = super
                .fling((int) (velocityX * mFlingFactor), (int) (velocityY * mFlingFactor));
        if (flinging) {
                ...
                .addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                    ...
                    public void onGlobalLayout() {
                        ...
                        if (mSmoothScrollTargetPosition >= 0
                                && mSmoothScrollTargetPosition < mViewPagerAdapter.getItemCount()) {
    ...
    private int transformInnerPositionIfNeed(int position) {
        if (isLoopEnabled() && position < ((LoopRecyclerViewPagerAdapter) mViewPagerAdapter)
                .getActualItemCount()) {
            final int actualItemCount = ((LoopRecyclerViewPagerAdapter) mViewPagerAdapter)
                    .getActualItemCount();
    ...
    protected void adjustPositionX(int velocityX) {
        ...
        if (childCount > 0) {
                ...
                if (centerXChild != null) {
                    if (mTouchSpan > centerXChild.getWidth() * mTriggerOffset * mTriggerOffset
                        ...
                        targetPosition--;
                            ...
                            && targetPosition != mViewPagerAdapter.getItemCount() - 1) {
                        targetPosition++;
                    }
                }
            }
            ...
            smoothScrollToPosition(
                    safeTargetPosition(targetPosition, mViewPagerAdapter.getItemCount()));
        }
    }
    ...
    public void onScrollStateChanged(int state) {
        ...
        if (state == SCROLL_STATE_DRAGGING) {
            ...
            if (mNeedAdjust) {
                int targetPosition = getLayoutManager().canScrollHorizontally() ? ViewUtils
