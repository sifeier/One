...
public class CircleProgressBar extends View {
    ...
    public CircleProgressBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        roundProgressColor = mTypedArray
                .getColor(R.styleable.CircleProgressBar_roundProgressColor, Color.GREEN);
        ...
        textIsDisplayable = mTypedArray
                .getBoolean(R.styleable.CircleProgressBar_textIsDisplayable, true);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int percent = (int) (((float) progress / (float) max)
                * 100);  //中间的进度百分比，先转换成float在进行除法运算，不然都为0
