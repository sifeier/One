...
public abstract class Button extends ICustomView {
	...
	protected void setDefaultProperties() {
		// Min size
		setMinimumHeight(Utils.dp2px(getContext(), minHeight));
		setMinimumWidth(Utils.dp2px(getContext(), minWidth));
		// Background shape
	...
	public Bitmap makeCircle() {
		Bitmap output = Bitmap.createBitmap(
				getWidth() - Utils.dp2px(getContext(), 6), getHeight()
						- Utils.dp2px(getContext(), 7), Config.ARGB_8888);
