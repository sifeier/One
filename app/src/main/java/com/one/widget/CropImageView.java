...
public class CropImageView extends ImageView {
    ...
    private void computeImageMatrix(Drawable drawable) {
        ...
        if (cropType != CropType.NONE && viewHeight > 0 && viewWidth > 0) {
            ...
            final float xTranslation = getXTranslation(cropType, viewWidth, postDrawableWidth,
                    verticalImageMode);
            final float postDrawabeHeigth = drawableHeight * scale;
            final float yTranslation = getYTranslation(cropType, viewHeight, postDrawabeHeigth,
                    verticalImageMode);
